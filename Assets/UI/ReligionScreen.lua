...
function PopulateAvailableBeliefs(beliefType:string)
	...
	for row in GameInfo.Beliefs() do
		...
		if (not m_pGameReligion:IsInSomePantheon(row.Index) and
			...
			((beliefType ~= nil and row.BeliefClassType == beliefType) or
			 (beliefType == nil and row.BeliefClassType ~= "BELIEF_CLASS_PANTHEON")) and
			 m_SelectedBeliefs[row.Index] == nil) then
